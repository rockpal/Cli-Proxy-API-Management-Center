    ...
    <section className={styles.providerSection}>
      <div className={styles.sectionHeader}>
        <h3 className={styles.sectionTitle}>
          <img src={iconCodex} alt="" className={styles.sectionIcon} />
            ...
            return (
              ...
              >
                ...
                {item.websockets !== undefined && (
                  <div className={cardStyles.metaRow}>
                    <span className={cardStyles.metaLabel}>{t('ai_providers.codex_websockets_label')}:</span>
                    <span className={cardStyles.metaValue}>{item.websockets ? t('common.yes') : t('common.no')}</span>
                  </div>
                )}
