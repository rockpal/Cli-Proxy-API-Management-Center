    ...
    <section className={styles.providerSection}>
      <div className={styles.sectionHeader}>
        <h3 className={styles.sectionTitle}>
          <img src={iconClaude} alt="" className={styles.sectionIcon} />
          ...
          {configs.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {item.cloak && (
                  <div className={cardStyles.metaRow}>
                    <span className={cardStyles.metaLabel}>{t('ai_providers.claude_cloak_mode_label')}:</span>
                ...
                {item.cloak?.strictMode ? (
                  <div className={cardStyles.metaRow}>
                    <span className={cardStyles.metaLabel}>{t('ai_providers.claude_cloak_strict_label')}:</span>
                    <span className={cardStyles.metaValue}>{t('common.yes')}</span>
                  </div>
                ) : null}
                {item.cloak?.sensitiveWords?.length ? (
                  <div className={cardStyles.metaRow}>
                    ...
                    <span className={cardStyles.metaValue}>{item.cloak.sensitiveWords.length}</span>
                  </div>
                ) : null}
